...
for (i in seq_along(files)) {
  ...
  write_data(
    ...
    file.path(drv_root, "valid_enrollment_periods_nov17")
  )
}
...
# export
write_data(washout, "hillary_nov17_washout_continuous_enrollment_dts.fst", drv_root)
